...
describe("Scope", function() {
	...
	describe("digest", function() {
		...
		it("calls listener with new value as undefined the first time", function() {
			var newValueGiven;

			scope.$watch(
				function(scope) { return scope.someValue; },
				function(newValue, oldValue, scope) { newValueGiven = newValue; }
			);

			scope.$digest();
			expect(newValueGiven).toBeUndefined();
		});
	...
	describe("$watchCollection", function() {
		...
		it("notices items recorded in an array", function() {
			scope.arr = [2, 1, 3];
			scope.counter = 0;
